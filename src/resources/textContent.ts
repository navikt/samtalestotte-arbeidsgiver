import {
    DEN_VIKTIGE_SAMTALEN, ENKLE_TIPS_FOR_DIGITALE_SAMTALER, GJENNOMFOR_SAMTALEN,
    GODE_GREP_FOR_AA_BYGGE_RELASJONER,
    KVALITETEN_PAA_SYKEFRAVAERSRUTINENE, OPPFOLGNINGSPLAN,
    RETTNINGSLINJER_FOR_SYKEFRAVAERSOPPFOLGNING
} from "./urls";
import {
    BigHeader,
    Columns,
    DocumentElement, HorizontalLine, InfoBox, isBigHeader, isColumns, isDownloadButtons, isHorizontalLine,
    isInfoBox, isLink, isList, isMediumHeader,
    isPanel,
    isParagraph,
    isSmallHeader, isText, Link, List, MediumHeader,
    Panel, Paragraph, SmallHeader, Text
} from "../dokumentgenerator/domainInterfaces";
import {isBoolean, isNumber, isString} from "../utils/typeGuardUtils";
...
const slikSkaperDuGodeSamtaler: (DocumentElement | object)[] = [
    ...
    {type: "Paragraph", content:[{type: "Text", content: "Som arbeidsgiver er du ansvalig for:", bold: true}]},
    {
        type: "List",
        content:[
...
const skapeGodeRammer: (Panel | object)[] = [{
    ...
    content: [
        ...
        {type: "HorizontalLine"},
        {type: "MediumHeader", content: "Gode rutiner effektiviserer arbeidet og skaper forutsigbarhet for deg og din medarbeider."},
        {type: "Paragraph", content: "Rutiner bør evalueres og justeres hvis de ikke bidrar til forutsigbarhet."},
        {type: "List", content: [["Hvordan bidrar sykefraværsrutinene i din virksomhet til forutsigbarhet rundt oppgaver og ansvar?"]]},
        {type: "SmallHeader", content: "Dette kan du gjøre:"},
        {
            type: "Columns",
            leftContent: [
                        ...
                        [{
                            ...
                            content: [
                                "Utarbeid sykefraværsrutiner. ",
                                {
                                    ...
                                    content: "Les mer om hvordan dere kan lage rutiner hos Idébanken.",
                                },
                            ]
                        }],
        ...
        {type: "Paragraph", content: "Arbeidet med rutiner bør settes inn i arbeidsplassens plan for å forebygge sykefravær slik at du kan dokumentere arbeidet."}
    ]
}]
...
const planleggeInnholdISamtalen : (Panel | object)[] = [{
        ...
        title: "Skape gode rammer",
        content: [
            {type: "Paragraph", content: "Legg en plan for hva du ønsker å oppnå og hvordan du kan gjennomføre samtalen. Husk å lytte til medarbeiderens behov."},
            {
                type: "List",
                content: [[
                    {type: "Text", content: "Hva er dine mål med samtalen?", bold: true},
                    {type: "Text", content: "Noter ned målet, og ha det framme når du er i samtalen.", lineBreak: 1},
                ...
                content: [[
                    {
                        type: "Paragraph",
                        content: [
                            {type: "Text", content: "Hvor trygg er du når du skal strukturere samtalen?", bold: true},
                            {type: "Text", content: "", lineBreak: 1},
                            {type: "Link", url: GJENNOMFOR_SAMTALEN, content: "Velg tema og hjelpespørsmål under “Gjennomfør samtalen ved å”"},
            ...
            },
            {
                ...
                content: [[
                    ...
                    {type: "Text", content: "Hvis du skal ta opp et tema du synes er vanskelig, bør du bør være konkret og tydelig på dine observasjoner.", lineBreak: 1},
                    {type: "Text", content: "Eksempler på observasjoner kan være:", lineBreak: 1},
                    {
                        type: "List",
                        content: [
    ...
    content: [
        {
            ...
            content: [
                ...
                [{
                    type: "Paragraph",
                    content: [
                        {type: "Link", url: ENKLE_TIPS_FOR_DIGITALE_SAMTALER, content: "Les mer om “Enkle tips for digitale samtaler”"},
                        " lenger ned på siden."
                    ]
                }],
                ...
                [{
                    ...
                    content: [
                        ...
                        {type: "Link", url: GJENNOMFOR_SAMTALEN, content: "“Gjennomfør samtalen ved å”"},
                        " lenger ned på siden."
                    ]
                }],
            ]
...
const innledeSamtalen = [{
    ...
    content: [
        {type: "Paragraph", content: "Å innlede en samtale handler om å skape trygghet, sette rammer og klargjøre mål og hensikt. Rammene hjelper dere med å holde fokus og tid."},
        {type: "Paragraph", content: [{type: "Text", content: "Vanlige tema i innledning:", bold: true}]},
        {
            type: "List",
            content: [
                ["ønske velkommen"],
...
const snakkeOmArbeid = [{
    ...
    content: [
        {type: "MediumHeader", content: "En samtale for å forebygge eller følge opp sykefravær handler om medarbeideren."},
        {type: "Paragraph", content: "Din oppgave er å legge til rette for at medarbeideren kan beskrive hvordan arbeidsoppgavene og arbeidsdagen oppleves."},
        {type: "SmallHeader", content: "Tips:"},
        {
            type: "List",
            content: [
        ...
        {type: "Paragraph", content: [{type: "Text", content: "Vanlige tema i samtalen om arbeidssituasjonen:", bold: true}]},
        {
            type: "List",
            content: [
                ["arbeidsoppgaver"],
        ...
        {type: "Paragraph", content: "Velg noen av eksemplene som er relevante for akkurat denne samtalen."},
        {
            type: "InfoBox",
            content: [
...
const finneLøsningerSammen = [{
    ...
    content: [
        ...
        {type: "Paragraph", content: "Hvis medarbeideren beskriver arbeidsoppgaver og arbeidssituasjon først, kan det bli enklere å se løsningsforslag selv. Egne løsningsforslag gir ofte økt motivasjon ved gjennomføring."},
        {type: "SmallHeader", content: "Tips:"},
        {type: "Paragraph", content: "Snakk om det som skal skje framover i tid og på hvilke muligheter som finnes."},
...
const planleggeVeienVidereSammen = [{
    ...
    content: [
        ...
        {type: "Paragraph", content: "En samtale om arbeidssituasjonen avsluttes med at du og medarbeideren oppsummerer det dere er blitt enige om og at dere lager en plan for videre oppfølging."},
        {type: "SmallHeader",  content: "Tips:"},
        {type: "Paragraph", content: "Det er lurt med flere korte oppsummeringer til hvert punkt dere har avtalt. Bruk spørsmål som kan besvares med ja eller nei for å sjekke at dere har felles forståelse."},
        {type: "Paragraph", content: "Dersom medarbeideren er sykmeldt er det pålagt å utarbeide en oppfølgingsplan. "},
        {type: "Paragraph", content: [{type: "Link", url: OPPFOLGNINGSPLAN, content: "Les mer om oppfølgingsplan på nav.no."}]},
        ...
        {type: "Paragraph", content: "Av og til blir du og medarbeideren ikke enige om løsningene og det er greit. Da dokumenterer du begges synspunkter i oppsummeringen eller oppfølgingsplanen."},
        {type: "Paragraph", content: [{type: "Text", content: "Tips:", bold: true}, " gjennomfør flere samtaler regelmessig."]},
    ]
}]
