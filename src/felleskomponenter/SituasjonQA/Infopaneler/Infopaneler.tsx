...
export const ForutsigbarInfopanelSvarJa: FunctionComponent = () => (
    <Panel border className={classNames('situasjonqa__info-panel', 'situasjonqa__info-panel-ja')}>
        Fint. Det er lurt å evaluere om rutiner fungerer etter hensikten regelmessig.
        <br />
        Hva fungerer bra hos dere?
        <br />
        <br />
        <span className="bold">Tips:</span> Evaluering av rutiner bør settes inn i deres plan for å
        forebygge sykefravær slik at du kan dokumentere arbeidet.
    </Panel>
);

export const ForutsigbarInfopanelSvarNei: FunctionComponent = () => (
    <Panel border className={classNames('situasjonqa__info-panel', 'situasjonqa__info-panel-nei')}>
        Gode rutiner effektiviserer arbeidet og skaper forutsigbarhet. Rutiner bør evalueres og
        justeres hvis de ikke gir ønsket verdi.
        <br />
        <br />
...
export const KjentInfopanelSvarNei: FunctionComponent = () => (
    <Panel border className={classNames('situasjonqa__info-panel', 'situasjonqa__info-panel-nei')}>
        Mange har gode rutiner som ledere eller medarbeidere ikke kjenner så godt til, kanskje fordi
        det er lenge siden de var i bruk? Rutiner bør revideres og repeteres regelmessig.
        <br />
        <br />
        <span className="bold">Tips:</span> Arbeidet med rutiner bør settes inn i deres plan for å
        forebygge sykefravær slik at du kan dokumentere arbeidet.
...
export const TillrettelagtInfopanelSvarJa: FunctionComponent = () => (
    <Panel border className={classNames('situasjonqa__info-panel', 'situasjonqa__info-panel-ja')}>
        Fint. Oversikt over tilretteleggingsmuligheter er et godt utgangspunkt for å finne gode
        løsninger.
        <br />
        <br />
        <span className="bold">Tips: </span>Husker dere å dele informasjonen med den som sykmelder
        medarbeideren?
    </Panel>
);
...
export const TillrettelagtInfopanelSvarNei: FunctionComponent = () => (
    <Panel border className={classNames('situasjonqa__info-panel', 'situasjonqa__info-panel-nei')}>
        Hvis du og medarbeideren er godt kjent med hvilke muligheter for tilrettelegging som finnes
        på deres arbeidsplass, kan det bli enklere å finne gode løsninger i samtalen.
        <br />
        <br />
        <span className="bold">Slik kan du utarbeide liste med tilretteleggingsmuligheter:</span>
        <br />
...
export const InfoPanelEnNei: FunctionComponent = () => (
    <Panel
        border
        className={classNames('situasjonqa__info-panel', 'situasjonqa__info-panel-en-nei')}
    >
        <span className="bold">Visste du?</span>
        <br />
        NAV hjelper virksomheter med å forebygge sykefravær.
        <br />
        Vi tilbyr digitale tjenester og kan også gi rådgivning hos dere på arbeidsplassen.
        <br />
        <br />
