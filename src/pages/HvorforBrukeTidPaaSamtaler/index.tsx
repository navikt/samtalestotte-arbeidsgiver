    ...
    return (
        <section className={className}>
            ...
            <p className={marginBottom2Rem}>
                ...
                sykefravær. Gode samtaler er en metode for hvordan du fyller lovkravene, slik at de
                gir størst verdi for deg og medarbeiderne dine.
            </p>
            <p className={boldText}>Gode samtaler bidrar til:</p>
            ...
            <Link href={'samtalestotte/verktoyet'}>Gå til verktøyet</Link>
