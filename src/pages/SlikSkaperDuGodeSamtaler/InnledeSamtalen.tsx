        ...
        >
            <div className={marginTop1Rem}>
                <BodyLong className={marginTop0Rem}>
                    Å innlede en samtale handler om å skape trygghet, sette rammer og klargjøre mål
                    og hensikt. Rammene hjelper dere med å holde fokus og tid.
                </BodyLong>
                <Label className={classNames(marginTop2Rem, marginBottom025rem)} size={'medium'}>
